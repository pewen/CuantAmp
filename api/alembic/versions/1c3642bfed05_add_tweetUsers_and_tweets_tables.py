...
def upgrade():
    ...
    op.create_table('twitter_users',
        ...
        sa.Column('profile_background_color', sa.String, nullable=True),
        sa.Column('profile_background_image_url_https', sa.String, nullable=True),
    ...
    op.create_table('twitter_users_seed',
    ...
    op.create_index(
        op.f('ix_twitter_users_seed_id'),
        'twitter_users_seed',
        ['id'],
        unique=True
    )
    op.create_index(
        op.f('ix_twitter_users_seed_user_id'),
        'twitter_users_seed',
        ['user_id'],
        unique=True
    )
    ...
    op.create_table('tweets',
        ...
        sa.Column('quoted_status_id', sa.BigInteger(), nullable=True),
        sa.Column('retweeted_status_id', sa.BigInteger(), nullable=True),
...
def downgrade():
    ...
    op.drop_index(
        op.f('ix_twitter_users_seed_user_id'),
        table_name='twitter_users_seed'
    )
    op.drop_index(
        op.f('ix_twitter_users_seed_id'), table_name='twitter_users_seed'
    )
    op.drop_table('twitter_users_seed')
